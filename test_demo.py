...
# model name
parser.add_argument('--experiment_name', type=str, default='model name', help='give a experiment name before training')
...
# dataset
parser.add_argument('--data_root', type=str, default=' ', help='data root folder')
parser.add_argument('--list_dir', type=str, default=' ', help='data list_dir root folder')
...
parser.add_argument('--gpu_ids', type=int, nargs='+', default=[2,3], help='list of gpu ids')
